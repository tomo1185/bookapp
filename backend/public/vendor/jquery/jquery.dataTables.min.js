...
(function (h) {
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "データがありません" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "_TOTAL_件中 _START_ - _END_ 件表示",
            // sInfo: "Showing _START_ to _END_ of _TOTAL_ entries",
            sInfoEmpty: "_TOTAL_件中 _START_ - _END_ 件表示",
            // sInfoEmpty: "Showing 0 to 0 of 0 entries",
            sInfoFiltered: "(検索対象: _MAX_ 件中)",
            // sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "1ページの表示件数: _MENU_ 件",
